"""
Unit tests for geoparser/db/spatialite/loader.py
...
from geoparser.db.spatialite.loader import (
    get_spatialite_path,
...
class TestGetSpatialitePath:
    ...
    @patch("geoparser.db.spatialite.loader.platform.machine")
...
class TestLoadSpatialiteExtension:
    ...
    def test_modifies_path_on_windows(self, mock_system):
        ...
        with patch("geoparser.db.spatialite.loader.os.environ") as mock_environ:
