...
class TestGazetteerIntegration:
    ...
    def test_creates_with_gazetteer_name(self, test_engine, andorra_gazetteer):
    ...
    def test_search_exact_finds_location(self, test_engine, andorra_gazetteer):
    ...
    def test_search_phrase_finds_location(self, test_engine, andorra_gazetteer):
    ...
    def test_search_permuted_finds_location(self, test_engine, andorra_gazetteer):
    ...
    def test_search_partial_finds_location(self, test_engine, andorra_gazetteer):
    ...
    def test_search_substring_finds_location(self, test_engine, andorra_gazetteer):
    ...
    def test_search_fuzzy_finds_location(self, test_engine, andorra_gazetteer):
    ...
    def test_search_respects_limit_parameter(self, test_engine, andorra_gazetteer):
    ...
    def test_search_respects_ranks_parameter(self, test_engine, andorra_gazetteer):
    ...
    def test_search_normalizes_quotes(self, test_engine, andorra_gazetteer):
    ...
    def test_search_strips_whitespace(self, test_engine, andorra_gazetteer):
    ...
    def test_find_returns_specific_feature(self, test_engine, andorra_gazetteer):
    ...
    def test_find_returns_none_for_nonexistent_feature(
    ...
    def test_search_returns_feature_objects(self, test_engine, andorra_gazetteer):
    ...
    def test_feature_has_geometry(self, test_engine, andorra_gazetteer):
    ...
    def test_feature_has_names(self, test_engine, andorra_gazetteer):
    ...
    def test_searches_multiple_parishes(self, test_engine, andorra_gazetteer):
        ...
        with patch("geoparser.db.engine.get_engine", return_value=test_engine):
            ...
            found_parishes = sum(
                1 for results in results_per_parish if len(results) > 0
            )
            assert found_parishes >= 2  # At least 2 parishes should be found

    def test_search_case_insensitive(self, test_engine, andorra_gazetteer):
    ...
    def test_handles_special_characters(self, test_engine, andorra_gazetteer):
    ...
    def test_search_returns_consistent_results(self, test_engine, andorra_gazetteer):
    ...
    def test_different_search_methods_return_different_results(
        self, test_engine, andorra_gazetteer
    ):
    ...
    def test_find_feature_has_source_relationship(self, test_engine, andorra_gazetteer):
    ...
    def test_find_feature_has_gazetteer_through_source(
        self, test_engine, andorra_gazetteer
    ):
