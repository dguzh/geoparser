...
def test_create(test_db: DBSession):
    ...
    module_create = RecognitionModuleCreate(
        ...
        config={"model": "en_core_web_sm", "threshold": 0.8},
    )
    ...
    assert created_module.config == {"model": "en_core_web_sm", "threshold": 0.8}
    ...
    assert db_module.config == {"model": "en_core_web_sm", "threshold": 0.8}
...
def test_get_by_name_and_config(test_db: DBSession):
    """Test getting a recognition module by name and config."""
    # Create modules with the same name but different configs
    config1 = {"model": "en_core_web_sm", "threshold": 0.8}
    config2 = {"model": "en_core_web_lg", "threshold": 0.7}
    ...
    # Test with valid name but different config
    retrieved_module = RecognitionModuleRepository.get_by_name_and_config(
    ...
    # Test with valid name but non-existent config
    non_existent_config = {"model": "non_existent_model", "threshold": 0.5}
    retrieved_module = RecognitionModuleRepository.get_by_name_and_config(
...
def test_get_all(test_db: DBSession, test_recognition_module: RecognitionModule):
    ...
    module_create = RecognitionModuleCreate(
        name="another-recognition-module", config={"model": "en_core_web_md"}
    )
    module = RecognitionModule(name=module_create.name, config=module_create.config)
    test_db.add(module)
    test_db.commit()
...
def test_update(test_db: DBSession, test_recognition_module: RecognitionModule):
    ...
    module_update = RecognitionModuleUpdate(
        ...
        config={"model": "updated-model", "threshold": 0.9},
    )
    ...
    assert updated_module.config == {"model": "updated-model", "threshold": 0.9}
    ...
    assert db_module.config == {"model": "updated-model", "threshold": 0.9}
...
def test_delete(test_db: DBSession, test_recognition_module: RecognitionModule):
    ...
    module_create = RecognitionModuleCreate(
        name="module-to-delete", config={"model": "to-be-deleted"}
    )
    module = RecognitionModule(name=module_create.name, config=module_create.config)
    test_db.add(module)
    test_db.commit()
    ...
    assert deleted_module.config == {"model": "to-be-deleted"}
